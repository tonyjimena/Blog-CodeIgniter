            ...
            <?php
                ...
                foreach ( $authors as $autor) 
                {
                  ...
                  echo '<tr>
                    ...
                    <td>'.$enabled.'</td>
                    <td><a href="/edit_autor/'.$autor['id'].'"><img src="/images/edit.svg" width=20px></a></td>
                    <td><a href="#" OnClick="delete_author('.$autor['id'].')"><img src="/images/delete_2.svg"  width=20px></a></td>
                  </tr>';
